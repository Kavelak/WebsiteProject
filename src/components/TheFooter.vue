    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          <a href="https://www.aman.com/" class="footer-logo" title="Aman resorts">
            <svg viewBox="0 0 775.8 207.1" width="100" height="27" aria-label="Aman resorts">
          ...
          <p class="footer-tagline">Aman Tokyo</p>
          <div class="footer-social">
            <a v-for="s in socialLinks" :key="s.label" :href="s.href" class="footer-social__link" target="_blank" rel="noopener noreferrer">{{ s.label }}</a>
          </div>
        </div>

        <nav class="footer-nav">
          <a v-for="link in footerLinks" :key="link.label" :href="link.href" class="footer-nav__link">{{ link.label }}</a>
        </nav>
      ...
      <div class="footer-bottom">
        <p class="footer-copy">&copy; {{ year }} Aman Resorts. All rights reserved.</p>
        <a href="https://www.aman.com/privacy-policy" class="footer-copy">Privacy Policy</a>
      </div>
    </div>
  </footer>
</template>
...
<script setup>
import { footerLinks, socialLinks, contact } from '../data/content.js'
